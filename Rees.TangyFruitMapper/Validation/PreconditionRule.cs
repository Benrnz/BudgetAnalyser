...
{
    /// <summary>
    /// An abstract type to describe the shape of a precondition rule.  These rules are applied and evaluated against Dto and Model types before they are mapped.
    /// </summary>
