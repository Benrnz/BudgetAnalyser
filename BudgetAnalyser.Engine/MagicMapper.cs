...
{
    /// <summary>
    /// An AutoMapper implementation of mapping one type to another. This relies on all AutoMapper maps being pre-created beforehand (preferably application start up).
    /// </summary>
        ...
        where TDestination : class
    {
        ...
        /// It is not necessary to override this method in a derived class unless additional is required after the data is copied from the source into the destination.
        ...
        /// <returns>
        /// A new instance of <typeparamref name="TDestination"/> mapped from <paramref name="source"/>. All properties will be populated in accordance with
