...
{
    /// <summary>
    ///     Optional, register as a named instance by specifying a name here. If no name is specified then the class is registered as a default instance. If a name is specified, then multiple
    ///     registrations can be done for the same type/interface. If specified, this name must be used when requesting an instance from the IoC container.
    /// </summary>
