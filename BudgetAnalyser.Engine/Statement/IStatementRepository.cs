...
namespace BudgetAnalyser.Engine.Statement
{
    ...
    {
        /// <summary>
        ///     Creates a new transaction file to store transactions and data for the <see cref="ITransactionManagerService" />
        /// </summary>
        Task CreateNewAsync(string storageKey);
