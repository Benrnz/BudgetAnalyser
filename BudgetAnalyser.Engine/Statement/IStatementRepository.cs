...
public interface IStatementRepository
{
    ...
    Task<TransactionSetModel> ImportBankStatementAsync(string storageKey, Account account);
    ...
    /// <summary>
    ///     Save the given <see cref="TransactionSetModel" /> into persistent storage. Files are saved into the proprietary Budget Analyser CSV format.
    /// </summary>
    /// <param name="transactionSetModel">The model to save.</param>
    /// <param name="isEncrypted">A boolean to indicate if the data file should be encrypted or not.</param>
    Task SaveAsync(TransactionSetModel transactionSetModel, bool isEncrypted);
}
