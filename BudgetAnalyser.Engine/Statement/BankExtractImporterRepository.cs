...
/// <summary>
///     A <see cref="IBankExtractImporter" /> repository based on a list of dependency-injected importers.
///     These are the bank specific file formats exported from online banking to be imported into the Budget Analyser.
/// </summary>
[AutoRegisterWithIoC(SingleInstance = true)]
public class BankExtractImporterRepository : IBankExtractImporterRepository
{
    private readonly IEnumerable<IBankExtractImporter> importers;

    /// <summary>
    ///     Initializes a new instance of the <see cref="BankExtractImporterRepository" /> class.
    /// </summary>
    /// <param name="importers">The importers.</param>
    /// <exception cref="System.ArgumentNullException"></exception>
    public BankExtractImporterRepository(IEnumerable<IBankExtractImporter> importers)
    {
    ...
    /// </summary>
    public async Task<TransactionsListModel> ImportAsync(string fullFileName, Account account)
    {
