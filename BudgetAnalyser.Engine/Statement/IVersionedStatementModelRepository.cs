...
public interface IVersionedStatementModelRepository
{
    ...
    ///     Any existing data at this location will be overwritten. After this is complete, use the <see cref="LoadAsync" /> method to load the new <see cref="TransactionsListModel" />.
    /// </summary>
    ...
    /// <summary>
    ///     Loads the <see cref="TransactionsListModel" />.
    /// </summary>
    ...
    /// <summary>
    ///     Saves the <see cref="TransactionsListModel" />.
    /// </summary>
    /// <param name="isEncrypted">A boolean to indicate if the data file should be encrypted or not.</param>
