...
/// <summary>
///     An interface for managing, viewing, and storing transactions. This service is designed to be stateful.
/// </summary>
public interface ITransactionManagerService : INotifyDatabaseChanges, IServiceFoundation
{
    ...
    /// <summary>
    ///     Provides a list of buckets for display purposes for filtering the transactions shown. This list will include a blank item to represent no filtering, and a [Uncategorised] to
    ///     represent a filter to show only transactions with no bucket allocation.
    /// </summary>
