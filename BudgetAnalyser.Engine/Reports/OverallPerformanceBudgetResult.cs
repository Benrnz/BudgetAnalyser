...
public class OverallPerformanceBudgetResult
{
    ...
    /// <summary>
    ///     Gets the average spend per month based on transactions-model transaction data over a period of time. cludes Surplus transactions, these are budgeted expenses only. Expected to be negative.
    /// </summary>
    public decimal AverageSpend { get; internal set; }

    /// <summary>
    ///     Gets the average surplus spending per month based on transactions-model transaction data over a period of time.
    /// </summary>
    ...
    /// <summary>
    ///     Validation messages based on inputs that may not produce the expected results. For example, if it covers multiple budgets during the period specified. Or, if, it's multiple budgets and
    ///     they have different periods, fortnightly and monthly.
    /// </summary>
