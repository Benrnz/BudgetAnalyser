...
{
    /// <summary>
    /// An interface to describe a localised set of AutoMapper configurations.  This allows AutoMapper configurations to be split apart so that each bound context can
