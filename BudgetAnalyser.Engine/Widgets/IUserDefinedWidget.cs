...
namespace BudgetAnalyser.Engine.Widgets
{
    ...
    ///     Each instance must be uniquely identified by the <see cref="Id" /> property combined with the
    ///     <see cref="WidgetType" /> Property.
    /// </summary>
    public interface IUserDefinedWidget
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="IUserDefinedWidget"/> is visibile. Ie: It has been hidden by the user.
        /// </summary>
