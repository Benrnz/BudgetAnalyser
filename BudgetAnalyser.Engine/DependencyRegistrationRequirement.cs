...
/// <summary>
///     Specifies a required IoC registration that is needed for the application to function. This class is used to return enough information back to the consuming UI code so it can register the
...
///     interfaces.
/// </summary>
[DebuggerDisplay("DependencyRegistrationRequirement: Type:{Type} Named:{NamedInstanceName}")]
public class DependencyRegistrationRequirement
{
    ...
    /// </summary>
    public bool IsSingleInstance { get; init; }
