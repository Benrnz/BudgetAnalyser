...
{
    /// <summary>
    ///     Specifies that there are required property injections to perform for the application to function.
    ...
    public class PropertyInjectionDependencyRequirement
    {
        ...
        /// </summary>
        public Action<object> PropertyInjectionAssignment { get; set; }
    }
}
