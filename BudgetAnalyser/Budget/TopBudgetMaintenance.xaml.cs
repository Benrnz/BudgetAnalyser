...
/// <summary>
///     Interaction logic for TopBudgetMaintenance.xaml
/// </summary>
public partial class TopBudgetMaintenance
{
    public TopBudgetMaintenance()
    {
        InitializeComponent();
    }

    private TopBudgetController Controller => (TopBudgetController)DataContext;

    private void OnDataContextChanged(object? sender, DependencyPropertyChangedEventArgs e)
    {
        if (e.OldValue is TopBudgetController controller)
        {
