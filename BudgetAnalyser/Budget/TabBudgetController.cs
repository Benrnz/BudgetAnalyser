...
public class TabBudgetController : ControllerBase, IShowableController
{
        ...
        : base(uiContext.Messenger)
    {
        ...
        Messenger.Register<TabBudgetController, ShellDialogResponseMessage>(this, static (r, m) => r.OnPopUpResponseReceived(m));
