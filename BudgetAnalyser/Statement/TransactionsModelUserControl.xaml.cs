...
/// <summary>
///     Interaction logic for TransactionsModelUserControl.xaml
/// </summary>
public partial class TransactionsModelUserControl
{
    ...
    public TransactionsModelUserControl()
    {
        InitializeComponent();
    }
    ...
    private void OnDataContextChanged(object? sender, DependencyPropertyChangedEventArgs e)
    {
        ...
        if (Controller.ViewModel.TransactionsModel is null)
        {
            return;
        }
