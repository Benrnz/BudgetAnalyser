...
public class TransactionToDtoMapperTest
{
    ...
    private readonly TransactionDto result;

    public TransactionToDtoMapperTest()
    {
    ...
    {
        this.result.Account.ShouldBe(TestData.Account.Name);
    }
    ...
    {
        this.result.BudgetBucketCode.ShouldBe(TestData.BudgetBucket!.Code);
    }
    ...
    {
        this.result.TransactionType.ShouldBe(TestData.TransactionType.Name);
    }
}
