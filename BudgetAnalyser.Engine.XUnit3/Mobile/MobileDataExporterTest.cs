...
public class MobileDataExporterTest
{
    ...
    public void CreateExportObject_ShouldReturn_WhenGivenTestData1()
    {
        ...
        var result = this.exporter.CreateExportObject(this.testTransactionsList, BudgetModelTestData.CreateTestData5(), this.testLedger, this.testCriteria);
    ...
    public void CreateExportObject_ShouldThrowArgumentException_WhenFilterDatesAreNull()
    {
        ...
        Assert.Throws<ArgumentException>(() => this.exporter.CreateExportObject(this.testTransactionsList, new BudgetModel(), this.testLedger, filter));
    }

    [Fact]
    public void CreateExportObject_ShouldThrowArgumentNullException_WhenCurrentBudgetIsNull()
    {
        Assert.Throws<ArgumentNullException>(() => this.exporter.CreateExportObject(this.testTransactionsList, null!, this.testLedger, this.testCriteria));
    }

    [Fact]
    public void CreateExportObject_ShouldThrowArgumentNullException_WhenFilterIsNull()
    {
        Assert.Throws<ArgumentNullException>(() => this.exporter.CreateExportObject(this.testTransactionsList, new BudgetModel(), this.testLedger, null!));
    }

    [Fact]
    public void CreateExportObject_ShouldThrowArgumentNullException_WhenLedgerBookIsNull()
    {
        Assert.Throws<ArgumentNullException>(() => this.exporter.CreateExportObject(this.testTransactionsList, new BudgetModel(), null!, this.testCriteria));
    }
