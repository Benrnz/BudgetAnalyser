...
namespace Rees.TestUtilities
{
    ...
    {
        /// <summary>
        /// Guards Against the specified exception. Use as a pre-condition checker to check parameters and conditions before getting into the core of a method.
        /// </summary>
        ...
        /// <typeparam name="T">The type of exception to guard against and throw should <paramref name="erroneousCondition"/> return true.</typeparam>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1004:GenericMethodsShouldProvideTypeParameter", Justification = "Best reading syntax")]
        ...
        /// </summary>
        /// <param name="erroneousCondition">The erroneous condition. If true the <paramref name="rectifyTheProblem"/> Action will be performed.</param>
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "Figuring out how and what exception to throw should not pollute the actual exception")]
        private static void AgainstInternal<T>(string message) where T : Exception, new()
        {
            ...
            if (ex == null)
            {
                try
                {
                    ex = Activator.CreateInstance(typeof(T), new object[] { message }) as T;
                }
                catch
                {
                    ex = new T();
