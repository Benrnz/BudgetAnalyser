...
public static class BudgetModelTestData
{
    ...
    {
        var collection = new BudgetCollection(CreateTestData1(), CreateTestData2()) { StorageKey = @"C:\Temp\Foo.xaml" };
        return collection;
    }

    public static BudgetCollection CreateCollectionWith2And5()
    {
        var collection = new BudgetCollection(CreateTestData5(), CreateTestData2()) { StorageKey = @"C:\Temp\Foo.xaml" };
        return collection;
    }

    public static BudgetCollection CreateCollectionWith5()
    {
        return new BudgetCollection(CreateTestData5());
    }
    ...
    public static BudgetModel CreateTestData1()
    {
        ...
        var expenses = new List<Expense>(
            new[]
            {
                new Expense { Amount = 95M, Bucket = new SavedUpForExpenseBucket(TestDataConstants.CarMtcBucketCode, "Car maintenance") },
                new Expense { Amount = 55M, Bucket = new SpentPerPeriodExpenseBucket(TestDataConstants.HairBucketCode, "Hair cuts") },
                new Expense { Amount = 175M, Bucket = new SpentPerPeriodExpenseBucket(TestDataConstants.PowerBucketCode, "Power") }
            });

        var incomes = new List<Income>(
            new[] { new Income { Amount = 1500M, Bucket = new IncomeBudgetBucket(TestDataConstants.IncomeBucketCode, "Pay") } });
    ...
    public static BudgetModel CreateTestData2()
    {
        ...
        var expenses = new List<Expense>(
            new[]
            {
                new Expense { Amount = 120M, Bucket = new SavedUpForExpenseBucket(TestDataConstants.PhoneBucketCode, "Phone/Internet") },
                new Expense { Amount = 100M, Bucket = new SavedUpForExpenseBucket(TestDataConstants.CarMtcBucketCode, "Car maintenance") },
                new Expense { Amount = 65M, Bucket = new SpentPerPeriodExpenseBucket(TestDataConstants.HairBucketCode, "Hair cuts") },
                new Expense { Amount = 185M, Bucket = new SpentPerPeriodExpenseBucket(TestDataConstants.PowerBucketCode, "Power") }
            });

        var incomes = new List<Income>(
            new[] { new Income { Amount = 1600M, Bucket = new IncomeBudgetBucket(TestDataConstants.IncomeBucketCode, "Pay") } });
    ...
    ///     Designed for use with LedgerBookTestData5 and TransactionsListViewModelTestData5
    /// </summary>
    public static BudgetModel CreateTestData5()
    {
        ...
        var expenses = new List<Expense>(
            new[]
            {
                new Expense { Amount = 300M, Bucket = new SavedUpForExpenseBucket(TestDataConstants.InsuranceHomeBucketCode, "Home Insurance") },
                new Expense { Amount = 120M, Bucket = new SavedUpForExpenseBucket(TestDataConstants.PhoneBucketCode, "Phone/Internet") },
                new Expense { Amount = 100M, Bucket = new SavedUpForExpenseBucket(TestDataConstants.CarMtcBucketCode, "Car maintenance") },
                new Expense { Amount = 65M, Bucket = new SpentPerPeriodExpenseBucket(TestDataConstants.HairBucketCode, "Hair cuts") },
                new Expense { Amount = 185M, Bucket = new SpentPerPeriodExpenseBucket(TestDataConstants.PowerBucketCode, "Power") }
        ...
        var incomes = new List<Income>(
            new[] { new Income { Amount = 2600M, Bucket = new IncomeBudgetBucket(TestDataConstants.IncomeBucketCode, "Pay") } });
