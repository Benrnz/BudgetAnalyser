...
internal sealed class SecureStringCredentialStore : ICredentialStore, IDisposable
{
    ...
    private SecureString passPhrase = new();
    ...
    {
        return this.passPhrase.Length == 0 ? null : (object)this.passPhrase;
    }
    ...
    [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly", MessageId = "SecureStringCredentialStore")]
    ...
    /// </summary>
    [SuppressMessage("Microsoft.Usage", "CA2213:DisposableFieldsShouldBeDisposed", MessageId = "passPhrase", Justification = "False positive, it is being disposed (C#6 syntax issue)")]
    public void Dispose()
    {
